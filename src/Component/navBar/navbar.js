...
function NavBar() {
  ...
  return (
    ...
    <div className="topnav">
      <a href="#home"><img src={weblogo} width="80px" /></a>
      <a href="#about" style={{ fontSize: '12px' }}><img src={ae} />Deliver To Dubia</a>
                ...
                <Container className='searchContainer'>
                  <Row>
                    ...
                    <Col  className='col right'>
                      <h6>{x.title}</h6>
                      <h6> Rs : {x.price}</h6>
                      <div className="navbtn"> <button>Add to cart</button></div>
                    </Col>
                  </Row>
                </Container>
              </div>
